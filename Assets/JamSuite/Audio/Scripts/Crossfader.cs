...
namespace JamSuite.Audio {
    ...
    public static class AudioSourceExt {
        ...
        public static Crossfader Crossfade(this AudioSource from, AudioSource to, float time = Crossfader.defaultDuration) {
        ...
        public static AudioSource Crossfade(this AudioSource source, AudioClip clip, float time = Crossfader.defaultDuration) {
